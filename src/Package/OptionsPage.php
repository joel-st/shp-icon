...
class OptionsPage
{
	...
	public function renderIcon($icon, $baseClass)
	{
		...
		echo '<div class="'.$baseClass.'__icon">';
		echo do_shortcode('['.shp_icon()->prefix.' icon="'.str_replace('.svg', '', $icon).'"]');
		echo '</div>';
		echo '<div class="'.$baseClass.'__meta">';
	...
	public function renderSettingsPage()
	{
		...
		echo '</th>';
		echo '<td>';
		echo '<p class="description">'._x('Inline-Icon display options', 'Options page settings description', 'shp-icon').'</p>';
		echo '</td></tr>';
