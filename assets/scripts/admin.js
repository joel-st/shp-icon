...
/***/ "./.build/assets/scripts/admin/delete.js":
/*!***********************************************!*\
  !*** ./.build/assets/scripts/admin/delete.js ***!
  \***********************************************/
...
(function ($) {
	$(function () {
		...
		$deleteAction.on('click', function (event) {
			...
			if(confirm((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__._x)('Confirm Deletion of', 'Confirm deletion. Confirm deletion of [IconName]', 'shp-icon') + ' ' + iconName)) {
				deleteIcon(fileName);
			}
		});
	});
		...
		if(icon) {
			...
			$.ajax({
				...
				success: function (response) {
					...
					const $status = $('<div class="notice notice-success"><p><b class="notice__filename">' + response.name + '</b> <span>' + (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__._x)('deleted', 'Admin notice delete file sucessfully', 'shp-icon') + '</span></p></div>');
...
/***/ "./.build/assets/scripts/admin/icon-actions.js":
/*!*****************************************************!*\
  !*** ./.build/assets/scripts/admin/icon-actions.js ***!
  \*****************************************************/
/***/ (function() {
...
/***/ "./.build/assets/scripts/admin/search-icon.js":
/*!****************************************************!*\
  !*** ./.build/assets/scripts/admin/search-icon.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./.build/assets/scripts/admin/upload.js":
/*!***********************************************!*\
  !*** ./.build/assets/scripts/admin/upload.js ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/i18n */ "./node_modules/@wordpress/i18n/build-module/index.js");
/* harmony import */ var _delete_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./delete.js */ "./.build/assets/scripts/admin/delete.js");
		...
		if($fileInput) {
			...
			$fileInput.change(function () {
				...
				Object.keys(fileList).forEach(key => {
					const $status = $('<div class="notice notice-info" data-id="' + uploadId + '"><p><b class="notice__filename">' + fileList[key]['name'] + '</b> <span>' + (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__._x)('processing', 'Admin notice processing [Filename] if file is selected for upload', 'shp-icon') + '</span></p><div class="spinner is-active"></div></div>');
					$statusElement.append($status);
					...
					$.ajax({
						...
						success: function (response) {
							...
							if(response.upload.error) {
								...
								$notice.find('p span').html((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__._x)('Something went wrong while processing the file.', 'Admin notice response.upload.error returns true', 'shp-icon'));
							} else {
								$notice.addClass('notice-success');
								$notice.find('p span').html('<b>' + response.name + '</b> ' + (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__._x)('Added successfully!', 'Admin notice [Icon] added successfully', 'shp-icon'));
						...
						error: function (XMLHttpRequest, textStatus, errorThrown) {
							...
							$notice.addClass('notice-error');
							$notice.find('p span').html((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__._x)('Upload failed!', 'Admin notice upload failed', 'shp-icon') + ' <i class="notice__error">' + XMLHttpRequest.responseJSON.message + '</i>');
					...
					success: function (response) {
						...
						$toggle.on('click', function () {
							...
							$deleteAction.on('click', function (event) {
								...
								if(confirm((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__._x)('Confirm Deletion of', 'Confirm deletion. Confirm deletion of [IconName]', 'shp-icon') + ' ' + iconName)) {
									(0,_delete_js__WEBPACK_IMPORTED_MODULE_1__.deleteIcon)(fileName);
								}
							});
						});
...
var __webpack_exports__ = {};
/*!**********************************************!*\
  !*** ./.build/assets/scripts/admin/index.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/i18n */ "./node_modules/@wordpress/i18n/build-module/index.js");
/* harmony import */ var _icon_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./icon-actions */ "./.build/assets/scripts/admin/icon-actions.js");
/* harmony import */ var _icon_actions__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_icon_actions__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _search_icon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./search-icon */ "./.build/assets/scripts/admin/search-icon.js");
/* harmony import */ var _upload__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./upload */ "./.build/assets/scripts/admin/upload.js");
/* harmony import */ var _delete__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./delete */ "./.build/assets/scripts/admin/delete.js");
/**
...
"use strict";
/*!*****************************************!*\
  !*** ./.build/assets/styles/admin.scss ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
