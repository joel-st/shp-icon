...
/***/ "./.build/assets/scripts/modernizr-svgforeignobject.js":
/*!*************************************************************!*\
  !*** ./.build/assets/scripts/modernizr-svgforeignobject.js ***!
  \*************************************************************/
/***/ (function() {
...
!function(e,n,s){function o(e){var n=f.className,s=Modernizr._config.classPrefix||"";if(c&&(n=n.baseVal),Modernizr._config.enableJSClass){var o=new RegExp("(^|\\s)"+s+"no-js(\\s|$)");n=n.replace(o,"$1"+s+"js$2")}Modernizr._config.enableClasses&&(n+=" "+s+e.join(" "+s),c?f.className.baseVal=n:f.className=n)}function t(e,n){return typeof e===n}function a(){var e,n,s,o,a,l,f;for(var c in r)if(r.hasOwnProperty(c)){if(e=[],n=r[c],n.name&&(e.push(n.name.toLowerCase()),n.options&&n.options.aliases&&n.options.aliases.length))for(s=0;s<n.options.aliases.length;s++)e.push(n.options.aliases[s].toLowerCase());for(o=t(n.fn,"function")?n.fn():n.fn,a=0;a<e.length;a++)l=e[a],f=l.split("."),1===f.length?Modernizr[f[0]]=o:(!Modernizr[f[0]]||Modernizr[f[0]]instanceof Boolean||(Modernizr[f[0]]=new Boolean(Modernizr[f[0]])),Modernizr[f[0]][f[1]]=o),i.push((o?"":"no-")+f.join("-"))}}var i=[],r=[],l={_version:"3.6.0",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,n){var s=this;setTimeout(function(){n(s[e])},0)},addTest:function(e,n,s){r.push({name:e,fn:n,options:s})},addAsyncTest:function(e){r.push({name:null,fn:e})}},Modernizr=function(){};Modernizr.prototype=l,Modernizr=new Modernizr;var f=n.documentElement,c="svg"===f.nodeName.toLowerCase(),u={}.toString;Modernizr.addTest("svgforeignobject",function(){return!!n.createElementNS&&/SVGForeignObject/.test(u.call(n.createElementNS("http://www.w3.org/2000/svg","foreignObject")))}),a(),o(i),delete l.addTest,delete l.addAsyncTest;for(var d=0;d<Modernizr._q.length;d++)Modernizr._q[d]();e.Modernizr=Modernizr}(window,document);


/***/ }),

/***/ "./.build/assets/scripts/ui/ie-polyfill.js":
/*!*************************************************!*\
  !*** ./.build/assets/scripts/ui/ie-polyfill.js ***!
  \*************************************************/
...
/* harmony export */   iePolyfill: function() { return /* binding */ iePolyfill; }
/* harmony export */ });
function iePolyfill() {
...
var __webpack_exports__ = {};
/*!*******************************************!*\
  !*** ./.build/assets/scripts/ui/index.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/i18n */ "./node_modules/@wordpress/i18n/build-module/index.js");
/* harmony import */ var _modernizr_svgforeignobject__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modernizr-svgforeignobject */ "./.build/assets/scripts/modernizr-svgforeignobject.js");
/* harmony import */ var _modernizr_svgforeignobject__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_modernizr_svgforeignobject__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ie_polyfill__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ie-polyfill */ "./.build/assets/scripts/ui/ie-polyfill.js");
/**
...
(0,_ie_polyfill__WEBPACK_IMPORTED_MODULE_2__.iePolyfill)();
