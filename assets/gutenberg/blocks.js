...
var external_wp_data_ = __webpack_require__(3);

// EXTERNAL MODULE: external ["wp","components"]
var external_wp_components_ = __webpack_require__(4);

// EXTERNAL MODULE: external ["wp","blockEditor"]
var external_wp_blockEditor_ = __webpack_require__(1);

// EXTERNAL MODULE: external ["wp","compose"]
var external_wp_compose_ = __webpack_require__(7);
...
/* harmony default export */ var icon_icon = (/*#__PURE__*/React.createElement(SVG, {
  width: "32",
  height: "30",
  viewBox: "0 0 32 30",
...
var classNameBase = Object(external_wp_blocks_["getBlockDefaultClassName"])(blockName);
/**
 * Register secure block
 */

/* harmony default export */ var block = (Object(external_wp_blocks_["registerBlockType"])(blockName, {
  title: Object(external_wp_i18n_["_x"])('SVG Icon', 'SVG icon block title', 'shp-icon'),
  description: Object(external_wp_i18n_["__"])('Use your SVG icons as Gutenberg block', 'shp-icon'),
  icon: icon_icon,
  category: 'embed',
  keywords: [Object(external_wp_i18n_["__"])('Icons'), Object(external_wp_i18n_["__"])('SVG')],
  supports: {
    align: false,
    anchor: true
  },
  ...
  edit: Object(external_wp_data_["withSelect"])(function (select) {
    return {
    ...
    return [/*#__PURE__*/React.createElement(external_wp_blockEditor_["BlockControls"], null), /*#__PURE__*/React.createElement(external_wp_blockEditor_["InspectorControls"], {
      className: "shp-icon-controls"
    }, /*#__PURE__*/React.createElement(external_wp_components_["PanelBody"], {
      title: Object(external_wp_i18n_["_x"])('Icon Collection', 'SVG icon block panel title', 'shp-icon'),
      initialOpen: true
    }, /*#__PURE__*/React.createElement("div", {
      className: "shp-icon-controls__icon-list"
    }, /*#__PURE__*/React.createElement(external_wp_components_["RadioControl"], {
      selected: icon,
    ...
    }))), /*#__PURE__*/React.createElement(external_wp_blockEditor_["PanelColorSettings"], {
      title: Object(external_wp_i18n_["_x"])('Color Settings', 'SVG icon block PanelColorSettings label', 'shp-icon'),
      colorSettings: [{
        value: color,
        ...
        label: Object(external_wp_i18n_["_x"])('Color', 'SVG icon block colorSettings label', 'shp-icon')
      }, {
        ...
        label: Object(external_wp_i18n_["_x"])('Background Color', 'SVG icon block colorSettings label', 'shp-icon')
      }]
    }, !hasCurrentColor && /*#__PURE__*/React.createElement("i", {
      style: {
        color: 'red'
      }
    }, Object(external_wp_i18n_["_x"])('The color feature only works with SVG’s using currentColor. No currentColor value found in the selected SVG.', 'SVG icon block colorSettings notice', 'shp-icon')))), /*#__PURE__*/React.createElement(external_wp_serverSideRender_default.a, {
      block: blockName,
...
var store = Object(external_wp_data_["registerStore"])('shp-icon/icon-list', {
  ...
  resolvers: {
    recieveIcons: /*#__PURE__*/regeneratorRuntime.mark(function recieveIcons(state) {
      var icons;
