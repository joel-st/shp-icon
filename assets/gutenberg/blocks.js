...
/* harmony import */ var _icon_jsx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./icon.jsx */ "./.build/assets/gutenberg/icon/icon.jsx");
 ...
 */
/* harmony default export */ __webpack_exports__["default"] = ((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__.registerBlockType)(blockName, {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__._x)("SVG Icon", "SVG icon block title", "shp-icon"),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Use your SVG icons as Gutenberg block", "shp-icon"),
  icon: _icon_jsx__WEBPACK_IMPORTED_MODULE_10__["default"],
  category: "embed",
  keywords: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Icons"), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("SVG")],
  supports: {
    align: false,
    anchor: true
  },
  ...
  edit: (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_6__.withSelect)(function (select) {
    return {
    ...
    return [/*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.InspectorControls, {
      className: "shp-icon-controls"
    }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__._x)("Icon Collection", "SVG icon block panel title", "shp-icon"),
      initialOpen: true
    }, /*#__PURE__*/React.createElement("div", {
      className: "shp-icon-controls__icon-list"
    }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.RadioControl, {
      selected: icon,
    ...
    }))), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_8__.PanelColorSettings, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__._x)("Color Settings", "SVG icon block PanelColorSettings label", "shp-icon"),
      colorSettings: [{
        value: color,
        ...
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__._x)("Color", "SVG icon block colorSettings label", "shp-icon")
      }, {
        ...
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__._x)("Background Color", "SVG icon block colorSettings label", "shp-icon")
      }]
    }, !hasCurrentColor && /*#__PURE__*/React.createElement("i", {
      style: {
        color: "red"
      }
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__._x)("The color feature only works with SVG’s using currentColor. No currentColor value found in the selected SVG.", "SVG icon block colorSettings notice", "shp-icon")))), /*#__PURE__*/React.createElement((_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_3___default()), {
      block: blockName,
...
var store = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_6__.registerStore)("shp-icon/icon-list", {
  ...
  resolvers: {
    recieveIcons: /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function recieveIcons(state) {
      var icons;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function recieveIcons$(_context) {
