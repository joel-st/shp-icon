...
/* harmony default export */ var block = (Object(external_this_wp_blocks_["registerBlockType"])('shp-icon/icon', {
  ...
  edit: Object(external_this_wp_data_["withSelect"])(function (select) {
    ...
    return [/*#__PURE__*/React.createElement(external_this_wp_blockEditor_["BlockControls"], null), /*#__PURE__*/React.createElement(external_this_wp_blockEditor_["InspectorControls"], {
      className: "shp-icon-controls"
    }, /*#__PURE__*/React.createElement(external_this_wp_components_["PanelBody"], {
    ...
    }, /*#__PURE__*/React.createElement(external_this_wp_components_["RadioControl"], {
      selected: icon,
    ...
    }))), /*#__PURE__*/React.createElement(external_this_wp_blockEditor_["PanelColorSettings"], {
    ...
    }, Object(external_this_wp_i18n_["_x"])('The color feature only works with SVG’s using currentColor. No currentColor value found in the selected SVG.', 'SVG icon block colorSettings notice', 'shp-icon')))), /*#__PURE__*/React.createElement(external_this_wp_serverSideRender_default.a, {
      block: "shp-icon/icon",
