...
/* harmony import */ var _icon_jsx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./icon.jsx */ "./.build/assets/gutenberg/icon/icon.jsx");
/* harmony import */ var _store_jsx__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./store.jsx */ "./.build/assets/gutenberg/icon/store.jsx");
...
/* harmony default export */ __webpack_exports__["default"] = ((0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_3__.registerBlockType)(blockName, {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__._x)("SVG Icon", "SVG icon block title", "shp-icon"),
  description: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Use your SVG icons as Gutenberg block", "shp-icon"),
  icon: _icon_jsx__WEBPACK_IMPORTED_MODULE_9__["default"],
  category: "embed",
  keywords: [(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Icons"), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("SVG")],
  supports: {
    align: false,
    anchor: true
  },
  ...
  edit: function edit(props) {
    ...
    if (!iconList.length) {
      ...
      }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Spinner, null)));
    }
    ...
    return [/*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.InspectorControls, {
      className: "shp-icon-controls"
    }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelBody, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__._x)("Icon Collection", "SVG icon block panel title", "shp-icon"),
      initialOpen: true
    }, /*#__PURE__*/React.createElement("div", {
      className: "shp-icon-controls__icon-list"
    }, /*#__PURE__*/React.createElement(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.RadioControl, {
      selected: icon,
    ...
    }))), /*#__PURE__*/React.createElement(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_6__.PanelColorSettings, {
      title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__._x)("Color Settings", "SVG icon block PanelColorSettings label", "shp-icon"),
      colorSettings: [{
        value: color,
        ...
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__._x)("Color", "SVG icon block colorSettings label", "shp-icon")
      }, {
        ...
        label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__._x)("Background Color", "SVG icon block colorSettings label", "shp-icon")
      }]
    }, icon && !hasCurrentColor && /*#__PURE__*/React.createElement("i", {
      style: {
        color: "red"
      }
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__._x)("The color feature only works with SVG’s using currentColor. No currentColor value found in the selected SVG.", "SVG icon block colorSettings notice", "shp-icon")))), /*#__PURE__*/React.createElement((_wordpress_server_side_render__WEBPACK_IMPORTED_MODULE_2___default()), {
      block: blockName,
...
var DEFAULT_ACTION = {};
var store = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.createReduxStore)("shp-icon/icon-list", {
  ...
  resolvers: {
    getEntries: /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function getEntries() {
      var path, entries;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function getEntries$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            return _context2.abrupt("return", store.actions.setState(entries));
          case 5:
          case "end":
